...
public class NetworkManager : MonoBehaviour
{
    ...
    {
        get { return onConnectCallBack; }
        set { onConnectCallBack = value; }
    }

    public Action<byte[]> OnDisConnectCallBack
    {
        get { return onDisConnectCallBack; }
        set { onDisConnectCallBack = value; }
    }

    public Action<byte[]> OnReceiveLineCallBack
    {
        get { return onReceiveLineCallBack; }
        set { onReceiveLineCallBack = value; }
    }

    public Action<byte[]> OnReceiveMsgCallBack
    {
        get { return onReceiveMsgCallBack; }
        set { onReceiveMsgCallBack = value; }
    }
